...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Projectile, function (sprite, otherSprite) {
    Watermelon.startEffect(effects.disintegrate)
    sprites.destroy(Watermelon)
    Flamingo.sayText("Crunch", 100, false)
    if (true) {
...
scene.setBackgroundImage(img`
    ...
    dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
    `)
Flamingo = sprites.create(assets.image`Mama`, SpriteKind.Player)
controller.moveOnlyOnscreenWithArrows(Flamingo, controller.Speeds.Fast)
...
let frequenz = 1000
forever(function () {
    Watermelon = sprites.createProjectileFromSide(assets.image`Water Melon`, randint(-50, -150), 0)
    Watermelon.y = randint(50, 115)
    pause(frequenz)
})
